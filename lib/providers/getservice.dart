...
// class ServiceProvider extends StateNotifier<AsyncValue<List<Data>>> {
//   final Ref ref;
...
//         final serviceModel = ServiceModel.fromJson(res); // Parse the full model

//         // Extract and flatten the service data list
//         List<Data> allServices = serviceModel.data ?? []; 

//         state = AsyncValue.data(allServices); // Store List<Data>
...
// final serviceProvider = StateNotifierProvider<ServiceProvider, AsyncValue<List<Data>>>(
