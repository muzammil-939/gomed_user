    ...
    return Column(
      ...
      children: [
        ...
        if (product.bookingStatus.toLowerCase() == "cancelled") ...[
              ...
              Text("Remaining Pay product: ₹${(product.price * product.quantity).toStringAsFixed(2)}"),
              const SizedBox(height: 12),
              Row(
                children: [
...
//             _buildStep(screenWidth, screenHeight, 2, "confirmed", product.currentStep >= 2),
//             _buildStepDivider(screenWidth, product.currentStep >= 3),
//             _buildStep(screenWidth, screenHeight, 3, "Out of Delivery", product.currentStep >= 3),
//             _buildStepDivider(screenWidth, product.currentStep >= 4),
//             _buildStep(screenWidth, screenHeight, 4, "Completed", product.currentStep >= 5),
//           ],
//         ),
//         const SizedBox(height: 10),
//         if(product.bookingStatus=="pending"||product.bookingStatus=="confirmed")
//         ElevatedButton(
//             onPressed: () async {
//               final confirmed = await showDialog<bool>(
//                 context: context,
